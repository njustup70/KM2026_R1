...
{
  StateBlock &s_rod = EC_flow.AddState("GetRod");
  StateBlock &s_dock = EC_flow.AddState("Docking");
  ...
  StateBlock &s_lay_pre = EC_flow.AddState("Pre LayBlock");
  StateBlock &s_lay = EC_flow.AddState("LayBlock");
